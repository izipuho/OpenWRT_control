...
class OpenWRTPackageList():
    ...
    def get_packages(self) -> None:
        ...
        packages = dict(self.hass.data[DOMAIN]["config"].get(
...
class OpenWRTProfile():
    ...
    def profile(self) -> dict:
        """Gather profile."""
        return {"lists": self.lists, "extra_include": self.extra_include,
    ...
    def get_profile(self):
        ...
        profile = self.hass.data[DOMAIN]["config"].get(
    ...
    def mod_profile(self, lists: set[str], extra_include: str = "", extra_exclude: str = "") -> None:
